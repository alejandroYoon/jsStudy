...
// let under16 = students.map(user => user.age < 16).map()
//     console.log(under16);
// }
...
let class2 = students.filter((user) => user.class === 2).map(user => user)
console.log (class2)

console.log ( "-------------  문제3")
// 3. 성별이 "gender"인 학생들만 출력해주세요
let gender2 = students.filter((user) => user.gender === "gender").map(user => user)
console.log (gender2) 
...
let name2 = students.name;
console.log(name2);
let age2 = students.age;
console.log (`제 이름은 ${name2}이고, 나이는 ${age2}입니다.`)
